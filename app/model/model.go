...
func (v *VoteOptUser) TableName() string { // 返回表名
...
type Vote struct {
	...
	Title       string    `gorm:"column:title;default:NULL;comment:'投票项目名称'"`
	...
	UserId      int64     `gorm:"column:user_id;default:NULL;comment:'创建者'"`
	CreatedTime time.Time `gorm:"column:created_time;default:NULL"`
	UpdatedTime time.Time `gorm:"column:updated_time;default:NULL"`
}
